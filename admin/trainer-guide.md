...
You can check the internal [**Network Information Portal** (NIP)](https://nip.wdf.sap.corp/nip2/faces/networking/wan/PublicAddresses.xhtml), to figure out the address ranges of your training location.
