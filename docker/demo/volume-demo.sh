...
echo "docker run -d -p 8081:8080 --name jenkins --mount source=jenkins_home,target=/var/jenkins_home jenkins/jenkins:lts-alpine"
echo ""
docker run -d -p 8081:8080  --name jenkins --mount source=jenkins_home,target=/var/jenkins_home jenkins/jenkins:lts-alpine
echo ""
