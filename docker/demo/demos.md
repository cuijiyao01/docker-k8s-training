...
Let’s see what else you could do with a bind mount:
`docker run -it -v /etc:/hostetc alpine:3.8`
...
`docker run -d -P -v jenkins_home:/var/jenkins_home jenkins/jenkins:lts`
