...
The K8s cluster prepared for the training is also serving a docker registry at  **registry.ingress.blrtr2.k8s-train.shoot.canary.k8s-hana.ondemand.com** to which you can push your image.
