...
If you want to push this image to our registry on **registry.ingress.blrtr2.k8s-train.shoot.canary.k8s-hana.ondemand.com**, tag your image with the name *secure_nginx* and your unique training ID and use `docker push` to push the image to the registry.
